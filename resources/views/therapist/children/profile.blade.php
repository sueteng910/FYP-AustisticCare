        ...
        <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-header">Set goal</div>
                                
                                <div class="row">
                                        <div class="col-lg-12">
                                                <form method="POST" action="{{action('PagesController@addGoal', '$childrens->id')}}" accept-charset="UTF-8" data-parsley-validate="" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                  <div class="form-group">
                                                        <input type="hidden" id="children_id" name="children_id" value="{!! $childrens->id !!}">

                                                          <label for="title">Goal</label>
                                                          <div class="">
                                                          <input type="text" class="form-control" id="goal" name = "goal" aria-describedby="emailHelp" placeholder="Enter name">
                                                      </div>
                                                  </div>
                                                </div>                  
                                                <div class="col-lg-6">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="">
                                                            <select name="category" class="form-control">
                                                                    <option value="1" class="form-control">SOCIAL COMMUNICATION</option>
                                                                    <option value="2" class="form-control">EMOTIONAL UNDERSTANDING</option>
                                                                    <option value="3" class="form-control">LEARNING</option>
                                                                  </select>
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                        <div class="form-group">
                                                          ...
                                                          <div class="">
                                                              @if ($goal_count >= 3)
                                                                <button class="btn btn-primary btn-success upload-result" id ="goalButton" name="goalButton" disabled >Submit</button>
                                                                <label for="start_date">Maximum is 3 goals at a time.</label>

                                                                @else
                                                                <button class="btn btn-primary btn-success upload-result" id ="goalButton" name="goalButton" >Submit</button>
                                                                @endif
                                                              </div>
                                                        </div>
