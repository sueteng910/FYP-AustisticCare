                          ...
                          <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="name" name = "step_3" aria-describedby="emailHelp" value = "{{$homework->step_3}}">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control" id="review" name = "review" aria-describedby="emailHelp" width="300px" value = "{{$homework->review}}" >
                              </div>
                              <div class="form-group">
                                <label for="name">Time taken</label>
                                <input type="text" readonly class="form-control" id="name" name = "step_3" aria-describedby="emailHelp" value = "">
                              </div>
