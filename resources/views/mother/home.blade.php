                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <th><a class="btn btn-primary" href="{{url('mother/calendar')}}/{{$childrens->id}}" role="button">Schedule</a></th>
                                        <th><a class="btn btn-primary" href="{{url('mother/homeworkList')}}" role="button">Homework</a>
                                    </div>
